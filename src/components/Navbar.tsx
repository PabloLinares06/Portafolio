      ...
      {navItems.map((item) => {
        ...
        return (
          <Link
            ...
            className={`relative px-4 py-2 text-[10px] md:text-xs font-mono uppercase tracking-widest transition-colors duration-300 rounded-full interactive ${isActive ? 'text-white' : 'text-gray-500 hover:text-gray-300'
              }`}
          >
            {isActive && (
              <motion.span
